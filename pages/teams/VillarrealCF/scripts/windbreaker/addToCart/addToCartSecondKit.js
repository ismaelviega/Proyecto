...
function addToCart(event){
    ...
    var windbreakervllcfsecond = {"Image" : sImage, "Price" : sPrice, "Quantity" : iQuantity,
                            "Name" : "", "Number" : "", "Size" : sSize};
    
    localStorage.setItem("windbreakerVLLCFSecond", JSON.stringify(windbreakervllcfsecond));
