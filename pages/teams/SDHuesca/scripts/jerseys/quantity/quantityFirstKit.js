...
document.getElementById("nameFirstKit").addEventListener('keypress', checkLengthName, false);
document.getElementById("nameFirstKit").addEventListener('keyup', nameToUpperCase, false);
...
function checkLengthName(){
    ...
    if (sName.length > 10){
        document.getElementById("nameFirstKit").value = document.getElementById("nameFirstKit").value.substring(0,10);
    }
}
